    ...
    <section id="section">
        ...
        <div class="content">
            <div id="users">
                <!-- Users -->
                 <?php
                    $activeUsersTab = $_GET['tab'] ?? 'activeUsersTab';
                ?>
                ...
                <div class="user-tabs">
                    ...
                    <div class="tab-content">
                        <!-- Active users -->
                        <?php if ($activeUsersTab === 'activeUsersTab'): ?>
                            <div class="tab-pane fade <?= ($_GET['tab'] ?? 'activeUsersTab') === 'activeUsersTab' ? 'show active' : '' ?>" id="activeUsersTab">
                                        ...
                                        <tbody>
                                            <?php while ($activeUsersRow = $activeUsersResultSet->fetch_assoc()): ?>
                                                ...
                                                <td data-label="Status">
                                                    <span class="badge rounded-pill success-badge"><?= $activeUsersRow['status']; ?></span>
                                                </td>
                                ...
                                <?php else: ?>
                                    <div id="empty">
                                        ...
                                        <small>No active user yet</small>
                        ...
                        <!-- Inactive users -->
                        <?php if ($activeUsersTab === 'inactiveUsersTab'): ?>
                            <div class="tab-pane fade <?= ($_GET['tab'] ?? '') === 'inactiveUsersTab' ? 'show active' : '' ?>" id="inactiveUsersTab">
                                <?php
                                    ...
                                    $filter = strtolower($_GET['filterInactiveUsers'] ?? '');
                                    ...
                                    $inactiveUsersRowCount = $inactiveUsersCountResult ? $inactiveUsersCountResult->fetch_assoc() : null;
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <?php while ($inactiveUsersRow = $inactiveUsersResultSet->fetch_assoc()): ?>
                                                ...
                                                <td data-label="Status">
                                                    <span class="badge rounded-pill danger-badge"><?= $inactiveUsersRow['status']; ?></span>
                                                </td>
                                ...
                                <?php else: ?>
                                    <div id="empty">
                                        <i class="fa-solid fa-ban"></i>
                                        <small>No inactive user yet</small>
                                        <small>Try to <a href="javascript:location.reload();"><i class="fa-solid fa-arrows-rotate"></i> reload</a> page</small>
                                    </div>
                                <?php endif; ?>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="profile-section">
                            ...
                            <p>
                                <small><b>Date Enrolled: </b><span id="a_created_at"></span></small>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="profile-section">
                            ...
                            <p>
                                <small><b>Date Enrolled: </b><span id="i_created_at"></span></small>
                            </p>
                        </div>
                    </div>
                </div>
