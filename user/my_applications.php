...
<head>
    ...
    <title>UrSafe - My Applications</title>
        ...
        <div class="offcanvas-body">
            <ul class="nav">
                ...
                <div class="top-nav">
                    ...
                    <li>
                        <a class="link active" href="my_applications.php">
                        ...
                        <?php if ($activeApplicationsTab === 'pendingApplicationsTab'): ?>
                            <div class="tab-pane fade <?= ($_GET['tab'] ?? 'pendingApplicationsTab') === 'pendingApplicationsTab' ? 'show active' : '' ?>" id="pendingApplicationsTab">
                                <?php
                                    ...
                                    $search = trim($_GET['searchMyPendingApplication'] ?? '');
                                    $filter = strtolower($_GET['filterMyPendingApplication'] ?? '');
                                    ...
                                    if ($isSearchFilterMode) {
                                        $stmtPending = $conn_local->prepare("CALL getSearchFilterMyPendingLockerApplications(?, ?, ?, ?, ?)");
                                        $stmtPending->bind_param("sssii", $id, $search, $filter, $limit, $offset);
                                    } else {
                                ...
                                <header class="searchFilter">
                                    <form method="GET">
                                        ...
                                        <div class="search-group">
                                            ...
                                            <input type="search"
                                                name="searchMyPendingApplication"
                                                placeholder="Search..."
                                                value="<?= htmlspecialchars($_GET['searchMyPendingApplication'] ?? '') ?>">
                                        </div>

                                        <div class="filter-group">
                                            <i class="fa-solid fa-filter"></i>
                                            <select name="filterMyPendingApplication" onchange="this.form.submit()">
                                                <option value="">All</option>
                                                <option value="newest" <?= (($_GET['filterMyPendingApplication'] ?? '') === 'newest') ? 'selected' : '' ?>>Newest</option>
                                                <option value="oldest" <?= (($_GET['filterMyPendingApplication'] ?? '') === 'oldest') ? 'selected' : '' ?>>Oldest</option>
                                            </select>
                                        </div>
                                ...
                                <div class="card-container">
                                    <?php if ($pendingResultSet->num_rows > 0): ?>
                                        ...
                                        <ul class="pagination">
                                            <li class="page-item <?= ($pendingPage <= 1) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=pendingApplicationsTab&pendingPage=<?= $pendingPage - 1 ?>&searchMyPendingApplication=<?= urlencode($_GET['searchMyPendingApplication'] ?? '') ?>&filterMyPendingApplication=<?= urlencode($_GET['filterMyPendingApplication'] ?? '') ?>">
                                                    Previous
                                                </a>
                                            </li>
                                            ...
                                            <li class="page-item <?= ($pendingPage >= $totalPagesPending) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=pendingApplicationsTab&pendingPage=<?= $pendingPage + 1 ?>&searchMyPendingApplication=<?= urlencode($_GET['searchMyPendingApplication'] ?? '') ?>&filterMyPendingApplication=<?= urlencode($_GET['filterMyPendingApplication'] ?? '') ?>#myLockerApplicationOffcanvas">
                                                    Next
                                                </a>
                                            </li>
                                        </ul>
                                    <?php else: ?>
                                        <div id="empty">
                                            ...
                                            <small>Try to <a href="javascript:location.reload();"><i class="fa-solid fa-arrows-rotate"></i> reload</a> page or <a href="lockers.php"><i class="fa-solid fa-file-lines"></i> apply locker slot</a></small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <?php if ($activeApplicationsTab === 'acceptedApplicationsTab'): ?>
                            <div class="tab-pane fade <?= ($_GET['tab'] ?? 'acceptedApplicationsTab') === 'acceptedApplicationsTab' ? 'show active' : '' ?>" id="acceptedApplicationsTab">
                                <?php
                                    ...
                                    $search = trim($_GET['searchMyAcceptedApplication'] ?? '');
                                    $filter = strtolower($_GET['filterMyAcceptedApplication'] ?? '');
                                    ...
                                    if ($isSearchFilterMode) {
                                        $stmtAccepted = $conn_local->prepare("CALL getSearchFilterMyAcceptedLockerApplications(?, ?, ?, ?, ?)");
                                        $stmtAccepted->bind_param("sssii", $id, $search, $filter, $limit, $offset);
                                    } else {
                                ...
                                <header class="searchFilter">
                                    <form method="GET">
                                        ...
                                        <div class="search-group">
                                            <i class="fa-solid fa-magnifying-glass"></i>
                                            <input type="search"
                                                name="searchMyAcceptedApplication"
                                                placeholder="Search..."
                                                value="<?= htmlspecialchars($_GET['searchMyAcceptedApplication'] ?? '') ?>">
                                        </div>

                                        <div class="filter-group">
                                            <i class="fa-solid fa-filter"></i>
                                            <select name="filterMyAcceptedApplication" onchange="this.form.submit()">
                                                <option value="">All</option>
                                                <option value="newest" <?= (($_GET['filterMyAcceptedApplication'] ?? '') === 'newest') ? 'selected' : '' ?>>Newest</option>
                                                <option value="oldest" <?= (($_GET['filterMyAcceptedApplication'] ?? '') === 'oldest') ? 'selected' : '' ?>>Oldest</option>
                                            </select>
                                        </div>
                                    ...
                                    <?php if ($acceptedResultSet->num_rows > 0): ?>
                                        ...
                                        <ul class="pagination">
                                            <li class="page-item <?= ($acceptedPage <= 1) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=acceptedApplicationsTab&acceptedPage=<?= $acceptedPage - 1 ?>&searchMyAcceptedApplication=<?= urlencode($_GET['searchMyAcceptedApplication'] ?? '') ?>&filterMyAcceptedApplication=<?= urlencode($_GET['filterMyAcceptedApplication'] ?? '') ?>">
                                                    Previous
                                                </a>
                                            </li>
                                            ...
                                            <li class="page-item <?= ($acceptedPage >= $totalPagesAccepted) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=acceptedApplicationsTab&acceptedPage=<?= $acceptedPage + 1 ?>&searchMyAcceptedApplication=<?= urlencode($_GET['searchMyAcceptedApplication'] ?? '') ?>&filterMyAcceptedApplication=<?= urlencode($_GET['filterMyAcceptedApplication'] ?? '') ?>#myLockerApplicationOffcanvas">
                                                    Next
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <?php if ($activeApplicationsTab === 'endedApplicationsTab'): ?>
                            <div class="tab-pane fade <?= ($_GET['tab'] ?? 'endedApplicationsTab') === 'endedApplicationsTab' ? 'show active' : '' ?>" id="endedApplicationsTab">
                                <?php
                                    ...
                                    $search = trim($_GET['searchMyEndedApplication'] ?? '');
                                    $filter = strtolower($_GET['filterMyEndedApplication'] ?? '');
                                    ...
                                    if ($isSearchFilterMode) {
                                        $stmtEnded = $conn_local->prepare("CALL getSearchFilterMyEndedLockerApplications(?, ?, ?, ?, ?)");
                                        $stmtEnded->bind_param("sssii", $id, $search, $filter, $limit, $offset);
                                    } else {
                                    ...
                                    $totalPagesEnded = ceil($totalEndedRow / $limit);
                                ...
                                <header class="searchFilter">
                                    <form method="GET">
                                        ...
                                        <div class="search-group">
                                            <i class="fa-solid fa-magnifying-glass"></i>
                                            <input type="search"
                                                name="searchMyEndedApplication"
                                                placeholder="Search..."
                                                value="<?= htmlspecialchars($_GET['searchMyEndedApplication'] ?? '') ?>">
                                        </div>

                                        <div class="filter-group">
                                            <i class="fa-solid fa-filter"></i>
                                            <select name="filterMyEndedApplication" onchange="this.form.submit()">
                                                <option value="">All</option>
                                                <option value="newest" <?= (($_GET['filterMyEndedApplication'] ?? '') === 'newest') ? 'selected' : '' ?>>Newest</option>
                                                <option value="oldest" <?= (($_GET['filterMyEndedApplication'] ?? '') === 'oldest') ? 'selected' : '' ?>>Oldest</option>
                                            </select>
                                        </div>
                                    ...
                                    <?php if ($endedResultSet->num_rows > 0): ?>
                                        ...
                                        <ul class="pagination">
                                            <li class="page-item <?= ($endedPage <= 1) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=endedApplicationsTab&endedPage=<?= $endedPage - 1 ?>&searchMyEndedApplication=<?= urlencode($_GET['searchMyEndedApplication'] ?? '') ?>&filterMyEndedApplication=<?= urlencode($_GET['filterMyEndedApplication'] ?? '') ?>">
                                                    Previous
                                                </a>
                                            </li>
                                            ...
                                            <li class="page-item <?= ($endedPage >= $totalPagesEnded) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=endedApplicationsTab&endedPage=<?= $endedPage + 1 ?>&searchMyEndedApplication=<?= urlencode($_GET['searchMyEndedApplication'] ?? '') ?>&filterMyEndedApplication=<?= urlencode($_GET['filterMyEndedApplication'] ?? '') ?>">
                                                    Next
                                                </a>
                        ...
                        <?php if ($activeApplicationsTab === 'historyApplicationsTab'): ?>
                            <div class="tab-pane fade <?= ($_GET['tab'] ?? 'historyApplicationsTab') === 'historyApplicationsTab' ? 'show active' : '' ?>" id="historyApplicationsTab">
                                <?php
                                    ...
                                    $search = trim($_GET['searchMyHistoryApplication'] ?? '');
                                    $filter = strtolower($_GET['filterMyHistoryApplication'] ?? '');
                                    ...
                                    if ($isSearchFilterMode) {
                                        $stmtHistory = $conn_local->prepare("CALL getSearchFilterMyLockerApplicationHistory(?, ?, ?, ?, ?)");
                                        $stmtHistory->bind_param("sssii", $id, $search, $filter, $limit, $offset);
                                    } else {
                                ...
                                <header class="searchFilter">
                                    <form method="GET">
                                        ...
                                        <div class="search-group">
                                            <i class="fa-solid fa-magnifying-glass"></i>
                                            <input type="search"
                                                name="searchMyHistoryApplication"
                                                placeholder="Search..."
                                                value="<?= htmlspecialchars($_GET['searchMyHistoryApplication'] ?? '') ?>">
                                        </div>

                                        <div class="filter-group">
                                            <i class="fa-solid fa-filter"></i>
                                            <select name="filterMyHistoryApplication" onchange="this.form.submit()">
                                                <option value="">All</option>
                                                <option value="newest" <?= (($_GET['filterMyHistoryApplication'] ?? '') === 'newest') ? 'selected' : '' ?>>Newest</option>
                                                <option value="oldest" <?= (($_GET['filterMyHistoryApplication'] ?? '') === 'oldest') ? 'selected' : '' ?>>Oldest</option>
                                            </select>
                                        </div>
                                    ...
                                    <?php if ($historyResultSet->num_rows > 0): ?>
                                        ...
                                        <ul class="pagination">
                                            <li class="page-item <?= ($historyPage <= 1) ? 'disabled' : '' ?>">
                                                <a class="page-link"
                                                href="?tab=historyApplicationsTab&historyPage=<?= $historyPage - 1 ?>&searchMyHistoryApplication=<?= urlencode($_GET['searchMyHistoryApplication'] ?? '') ?>&filterMyHistoryApplication=<?= urlencode($_GET['filterMyHistoryApplication'] ?? '') ?>">
                                                    Previous
                                                </a>
                                            </li>
