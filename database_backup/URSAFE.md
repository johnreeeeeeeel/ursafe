...
##### GET SEARCH FILTER LOCKER LOCATIONS
...
CREATE OR REPLACE PROCEDURE applyLockerSlot (
...
CREATE OR REPLACE PROCEDURE getLockerSlotApplication()
...
##### ACCEPT LOCKER SLOT APPLICATION
...
CREATE OR REPLACE PROCEDURE acceptLockerSlotApplication(
...
##### REJECT LOCKER SLOT APPLICATION
...
CREATE OR REPLACE PROCEDURE rejectLockerSlotApplication(
...
##### REVOKE LOCKER SLOT APPLICATION
...
CREATE OR REPLACE PROCEDURE revokeLockerSlotApplication(
...
##### GET USER LOCKER SLOT APPLICATIONS
...
CREATE OR REPLACE PROCEDURE getUserLockerSlotApplications(IN p\_user\_id VARCHAR(255))
...
##### GET USER SPECIFIC LOCKER SLOT DETAILS
...
CREATE OR REPLACE PROCEDURE getUserLockerSlotApplicationDetails (
...
##### GET USER SPECIFIC LOCKER SLOT ID
...
CREATE OR REPLACE PROCEDURE getUserLockerSlotApplicationId (
