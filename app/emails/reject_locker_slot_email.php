...
function sendLockerSlotRejected($email, $username, $location, $slot_number, $size, $price) {
    ...
    try {
        ...
        $mail->Body = "
            <div>
                ...
                <p>Your locker slot application has been <b>rejected</b>.</p>
