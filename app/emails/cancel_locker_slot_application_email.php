...
function sendLockerSlotCancellation($email, $username, $location, $slot_number, $size, $price) {
    ...
    try {
        ...
        // Email content
        $mail->isHTML(true);
        $mail->Subject = 'Cancelled Locker Application';

        $mail->Body = "
            <div>
                <h4>Hello {$username},</h4>

                <p>Your cancelled your locker application.</p>
