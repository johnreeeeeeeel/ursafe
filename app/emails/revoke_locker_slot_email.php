...
function sendLockerSlotRevoked($email, $username, $location, $slot_number, $size, $price) {
    ...
    try {
        ...
        $mail->Body = "
            <div>
                ...
                <p>Your locker slot application has been <b>revoked</b>.</p>
                ...
                <p>Failure to comply obligation.</p>
