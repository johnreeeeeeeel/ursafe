...
require '../emails/paid_locker_slot_email.php';
...
try {
    ...
    $stmt = $conn_local->prepare("CALL paidLockerApplication(?)");
    $stmt->bind_param("i", $app_id);
    $stmt->execute();
    $stmt->close();
    $conn_local->next_result();
    ...
    $_SESSION['alert_message'] = [
        'type' => 'success',
        'text' => 'Application paid successfully.'
    ];
...
header("Location: ../../admin/lockers.php#lockerEndedApplicationOffcanvas");
exit;
?>